    ...
    <div id="aboutme" className="container-fluid">
      <div className="row d-flex flex-wrap align-items-center">
        <div className="col-lg-6 col-sm-12">
          ...
          <h5 className="about-text">Goodness, where to even begin... I am a twenty-something year old web designer, musician, volunteer, nature-lover, and so many other things. I have many diverse interests, including pre-history, space, physics and natural sciences, music, and more! If I am not programming, I am either making music, watching documentaries or hockey or football, or spending time with family and friends or plants and animals.</h5>
